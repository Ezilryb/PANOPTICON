...
def _run_module_worker(module_name: str) -> None:
    ...
    if module_name == "argus":
        ...
        run_vault()
    elif module_name == "spectra":
        from modules.spectra.service import run_spectra

        run_spectra()
    elif module_name == "oracle":
        from modules.oracle.service import run_oracle

        run_oracle()
    elif module_name == "roster":
        from modules.roster.service import run_roster

        run_roster()
    elif module_name == "pulse_track":
        from modules.pulse_track.service import run_pulse_track
