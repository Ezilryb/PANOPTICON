...
et ORACLE sont désormais implémentés (voir panopticon/argus/, panopticon/roster/,
panopticon/spectra/ et panopticon/oracle/) ; les autres modules restent des
...
def build_default_registry() -> ModuleRegistry:
    ...
    (section 2 du document de référence). ARGUS, ROSTER, SPECTRA et ORACLE
    sont marqués `implemented=True` ; les autres restent `implemented=False` :
