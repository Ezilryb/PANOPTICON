...
dépendances et besoins en ressources approximatifs. ARGUS et ROSTER sont
désormais implémentés (voir panopticon/argus/ et panopticon/roster/) ; les
...
def build_default_registry() -> ModuleRegistry:
    ...
    (section 2 du document de référence). ARGUS et ROSTER sont marqués
