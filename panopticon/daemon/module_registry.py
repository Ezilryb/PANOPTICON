...
dépendances et besoins en ressources approximatifs. ARGUS, ROSTER et SPECTRA
sont désormais implémentés (voir panopticon/argus/, panopticon/roster/ et
panopticon/spectra/) ; les autres modules restent des déclarations en
...
def build_default_registry() -> ModuleRegistry:
    ...
    (section 2 du document de référence). ARGUS, ROSTER et SPECTRA sont marqués
    `implemented=True` ; les autres restent `implemented=False` : seule leur
    déclaration existe, aucun code de vision/traitement n'est fourni.
    """
